...
path_to_capture_sessions_dir = os.path.join(SPECTREPARENTPATH, 'host', 'capture_sessions')
path_to_start_capture = os.path.join(path_to_capture_sessions_dir, 'start_capture.py')
path_to_start_watcher = os.path.join(path_to_capture_sessions_dir, 'start_watcher.py')
