...
@jsendify_response
def get_batch_files_year_month_day(year: int, month: int, day: int) -> list[str]:
...
@jsendify_response
def get_tags_year_month_day(year: int, month: int, day: int) -> list[str]:
    validate_date(year, month, day)
...
def get_tags_year_month(
    ...
    validate_date(year, month)
    return batches.get_tags(year, month)
