...
class RSPdx(Base):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.add_mode(
            ...
            spectre_server.core.models.RSPdxFixedCenterFrequency,
            spectre_server.core.flowgraphs.RSPdxFixedCenterFrequency,
        ...
        self.add_mode(
            ...
            spectre_server.core.models.RSPdxSweptCenterFrequency,
            spectre_server.core.flowgraphs.RSPdxSweptCenterFrequency,
