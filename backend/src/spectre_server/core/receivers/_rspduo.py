...
class RSPduo(Base):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.add_mode(
            ...
            spectre_server.core.models.RSPduoFixedCenterFrequency,
            spectre_server.core.flowgraphs.RSPduoFixedCenterFrequency,
        ...
        self.add_mode(
            ...
            spectre_server.core.models.RSPduoSweptCenterFrequency,
            spectre_server.core.flowgraphs.RSPduoSweptCenterFrequency,
