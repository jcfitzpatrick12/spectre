...
class B200mini(Base):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.add_mode(
            ...
            spectre_server.core.models.B200miniFixedCenterFrequency,
            spectre_server.core.flowgraphs.USRPFixedCenterFrequency,
        ...
        self.add_mode(
            ...
            spectre_server.core.models.B200miniSweptCenterFrequency,
            spectre_server.core.flowgraphs.USRPSweptCenterFrequency,
