from spectre.receivers.CaptureConfigHandlerMount import CaptureConfigHandlerMount
...
class CaptureConfigHandler(CaptureConfigHandlerMount):
    def __init__(self,):
        super().__init__()
        pass
    ...
    def tuner_1_fixed_validator(self, capture_config_dict: dict) -> None:
