...
class tuner_1_fixed(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, capture_config):
        ...
        self.sdrplay3_rspduo_0.set_center_freq(capture_config['center_freq'])
        self.sdrplay3_rspduo_0.set_bandwidth(capture_config['bandwidth'])
        self.sdrplay3_rspduo_0.set_antenna("Tuner 1 50 ohm")
        self.sdrplay3_rspduo_0.set_gain_mode(False)
        self.sdrplay3_rspduo_0.set_gain(capture_config['IF_gain'], 'IF')
        self.sdrplay3_rspduo_0.set_gain(capture_config['RF_gain'], 'RF')
