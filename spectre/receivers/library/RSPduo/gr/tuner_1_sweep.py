...
class tuner_1_sweep(gr.top_block):
    ...
    def __init__(self, capture_config: dict):
        ...
        # Blocks
        ##################################################
        self.spectre_sweep_driver_0 = spectre.sweep_driver(min_freq, max_freq, freq_step, samp_rate, samples_per_step)
        self.spectre_batched_file_vector_sink_0 = spectre.batched_file_vector_sink(CONFIG.chunks_dir, tag, chunk_size, samp_rate, 3)
        ...
        self.sdrplay3_rspduo_0.set_center_freq(min_freq)
        ...
        self.connect((self.spectre_sweep_driver_0, 0), (self.spectre_batched_file_vector_sink_0, 0))
