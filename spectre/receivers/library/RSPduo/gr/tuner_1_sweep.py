...
class sweep_test(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.spectre_sweep_driver_0 = spectre.sweep_driver(90000000, 100000000, 1000000, 1000000, 1000000, 'freq')
        self.spectre_batched_file_sink_0 = spectre.batched_file_sink(CONFIG.path_to_chunks_dir, 'sweep-test', 3, 1000000, True, 'freq', 90000000)
        ...
        self.sdrplay3_rspduo_0.set_center_freq(90e6, True)
        self.sdrplay3_rspduo_0.set_bandwidth(1536e3)
...
#         ##################################################
#         # self.spectre_sweep_driver_0 = spectre.sweep_driver(90000000, 100000000, 1000000, 1000000, 1000000, 'freq')
#         # self.spectre_batched_file_sink_0 = spectre.batched_file_sink('/tmp/chunks', 'sweep-test', 3, 1000000, True, 'freq', 90000000)
#         # self.sdrplay3_rspduo_0 = sdrplay3.rspduo(
#         #     '',
#         #     rspduo_mode="Single Tuner",
#         #     antenna="Tuner 1 50 ohm",
