...
class BaseReceiver(ABC):
    ...
    def get_capture_method(self, mode: str) -> Callable:
    ...
    def get_validator(self, mode: str) -> Callable:
    ...
    def validate(self, capture_config: dict) -> None:
        validator = self.get_validator(self.mode)
    ...
    def start_capture(self, tags: list) -> None:
        ...
        capture_method = self.get_capture_method(self.mode)
